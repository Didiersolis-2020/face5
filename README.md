Clasificación del compromiso ("Alto", "Medio" o "Bajo")
    """
...
def main():
    ...
    for sesion in matriz_sesiones:
        ...
        clasificacion = clasificar formato f-string con alineación a la izquierda para mejor legibilidad
        print(f"{id_cliente:<15} | {clasificacion}")
 
_compromiso(duracion, clics)
...
# _name_ es "_main_" solo cuando el archivo se ejecuta directamente
if _name_ == "_main_":
